<?php
session_start();
if (isset($_SESSION['Correo']) != "Jarimices@gmail.com") {
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="Registrar_Producto.php">Registrar Producto</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="Registrar.php">Registrar Personas</a>
          </li>
          <li class="nav-item">
  ...
  <style>
        body {
            ...
            background-image: url("./Fotoicon/a4206232b5b23615f764916e83efdbea.gif");
